...
print_final_message() {
    if check_node_status; then
        ...
        printf "Refer \e[4mhttps://github.com/NetSepio/astro/blob/main/docs/docs.md\e[0m for API documentation.\n"
...
run_node() {
    ...
    (sudo docker run -d -p 9080:9080/tcp -p 9002:9002/tcp -p 51820:51820/udp \
        ...
        --name astro --env-file "${ENV_FILE}" ghcr.io/netsepio/astro:main > /dev/null 2> error.log) &
    show_spinner $!
    wait $!
